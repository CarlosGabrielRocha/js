...
console.log("M\xE9dia Aritm\xE9tica Simples: ".concat(avarage(3, 6, 10, 9)));
...
console.log("M\xE9dia Ponderada: ".concat(weightedAvarage({
  number: 9,
  weight: 3
}, {
  number: 7
...
console.log("Mediana: ".concat(median(9, 2, 6, 9, 10, 11)));
...
console.log("Moda: ".concat(mode(5, 5, 7, 2, 1, 5, 6, 9, 10, 11)));
