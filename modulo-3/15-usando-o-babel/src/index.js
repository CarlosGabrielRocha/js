...
console.log(`Média Aritmética Simples: ${avarage(3, 6, 10, 9)}`)
...
console.log(`Média Ponderada: ${weightedAvarage(
    { number: 9, weight: 3 },
    { number: 7},
    { number: 10, weight: 1 }
)}`)
...
console.log(`Mediana: ${median(9, 2, 6, 9, 10, 11)}`)
...
console.log(`Moda: ${mode(5, 5, 7, 2, 1, 5, 6, 9, 10, 11)}`)